...
import { Loader2, Home, Bot, CheckCircle, ArrowLeft, ArrowRight, Users, Star, Search, X, ChevronDown, ChevronUp, Heart, MessageCircle, MapPin, Bed, Wifi, Utensils } from "lucide-react";
...
export function DormsQuiz({ moduleConfig }: { moduleConfig: ModuleConfig }) {
      ...
      const searchResults: Recommendation[] = [
        {
          ...
          roomType: "Search Result",
          amenities: ["Search Result"],
          score: 85,
  ...
  const handleApply = () => {
    alert(`Applying to ${selectedRecommendations.length} selected housing options!`);
      ...
      <div className="space-y-6">
        <Card className="w-full max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Let's get more specific to provide better housing recommendations
            </CardDescription>
          </CardHeader>
        </Card>
      ...
      <div className="space-y-6">
        <Card className="w-full max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Based on your preferences, here are 5 housing options we think you'll love
            </CardDescription>
          </CardHeader>
        </Card>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      {rec.amenities.length > 3 && (
                        <Badge variant="outline" className="text-xs">
                          +{rec.amenities.length - 3} more
                        </Badge>
                      )}
                    </div>
                  </div>
              ...
              {expandedRecommendation === rec.id && (
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-blue-600 mb-2">Why This Housing is Perfect for You</h4>
                  ...
                  {rec.roommateMatch && (
                    <div>
                      <h4 className="font-semibold text-green-600 mb-2">Potential Roommate Match</h4>
                      <div className="bg-green-50 p-4 rounded-lg">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">{rec.roommateMatch.name}</p>
                            <p className="text-sm text-gray-600">
                              Compatibility: {rec.roommateMatch.compatibility}%
                            </p>
                            <div className="flex flex-wrap gap-1 mt-1">
                              {rec.roommateMatch.sharedInterests.map((interest, idx) => (
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-600 mb-2">All Amenities</h4>
                    <div className="flex flex-wrap gap-2">
          ...
          <Card className="w-full max-w-4xl mx-auto">
            ...
            <CardContent>
              <div className="flex gap-2">
                <Input
                  placeholder="Search for specific housing options, locations, or amenities..."
                  value={searchQuery}
        ...
        <div className="flex justify-between items-center max-w-4xl mx-auto">
          <div className="text-sm text-gray-600">
            Selected: {selectedRecommendations.length}/5 housing options
          </div>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p>Loading housing assessment...</p>
        </div>
      </div>
    );
  }
